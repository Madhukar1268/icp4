...
public class translate extends AppCompatActivity {
    ...
    public void translateText(View v) {
        TextView sourceTextView = (TextView) findViewById(R.id.editText5);
        EditText srclng = (EditText) findViewById(R.id.editText3);
        EditText tgtlng = (EditText) findViewById(R.id.editText4);
